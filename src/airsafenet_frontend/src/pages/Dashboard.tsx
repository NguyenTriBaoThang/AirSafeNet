...
export default function Dashboard() {
  ...
  if (error) {
    return <EmptyState title="Không tải được dữ liệu dashboard" description={error} />;
  }
  ...
  const currentVariant =
    summary.currentRisk === "GOOD" ? "success"
    : summary.currentRisk === "MODERATE" ? "warning"
    : "danger";
    ...
    <div className="dashboard-page">
      ...
      <div className="summary-grid">
        ...
        <SummaryCard
          ...
          subtext={summary.peakTime ? `Đỉnh lúc ${new Date(summary.peakTime).toLocaleString("vi-VN")}` : undefined}
